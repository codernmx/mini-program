...
function u() {
    var t = {
        dm: "wechat.apps.xx",
        url: encodeURIComponent(s() + c(_.Data.pageQuery)),
        pvi: "",
        si: "",
        ty: 0
    };
...
function f() {
    ...
    Page = function(a) {
        ...
        a.onLoad = function(t) {
            ...
            _.Data.lastPageUrl = _.Data.pageUrl, _.Data.pageUrl = s(), _.Data.show = !1, _.Page.init();
        }, t(a);
    };
}
    ...
    Event: {
        stat: function(t, a) {
            if ("" != g.event_id) {
                ...
                var o, i = void 0 === a ? {} : a, s = [];
                for (o in i) i.hasOwnProperty(o) && s.push(encodeURIComponent(o) + "=" + encodeURIComponent(i[o]));
                for (i = s.join(";"), r.r5 = i, i = 0, r = (n = [ n, r, p(), {
                    rand: +new Date()
                } ]).length; i < r; i++) for (var c in n[i]) n[i].hasOwnProperty(c) && e.push(c + "=" + (void 0 === n[i][c] ? "" : n[i][c]));
            }
        }
    },
    Data: {
