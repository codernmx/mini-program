...
(0, e.VantComponent)({
    ...
    methods: {
        ...
        setColumnValues: function(e, t) {
            var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], r = this.children[e];
            if (null == r) return Promise.reject(new Error("setColumnValues: 对应列不存在"));
            var s = JSON.stringify(r.data.options) === JSON.stringify(t);
            return s ? Promise.resolve() : r.set({
                options: t
            }).then(function() {
                n && r.setIndex(0);
            });
